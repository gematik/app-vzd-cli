...
class TestCert {
    ...
    fun testCertificateParsingDER() {
        ...
        assertEquals("CN=Testpraxis US 667 TEST-ONLY,O=72210729667 NOT-VALID,C=DE", cert.subjectX500Principal.name)
