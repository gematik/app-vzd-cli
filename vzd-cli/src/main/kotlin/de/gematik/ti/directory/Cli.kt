...
import de.gematik.ti.directory.ldif.LdifCommand
import de.gematik.ti.directory.pers.PersCommand
...
class Cli : CliktCommand(name = "vzd-cli") {
    ...
    init {
        versionOption(de.gematik.ti.directory.BuildConfig.APP_VERSION)
        subcommands(DirectoryAdministrationCli(), LdifCommand(), PersCommand())
    }
