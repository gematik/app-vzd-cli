...
enum class DirectoryEntryKind(val matcher: (DirectoryEntry) -> Boolean) {
    Arzt({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("1-1") ||
                (it.startsWith("1-") && directoryEntry.directoryEntryBase.personalEntry == true)
    }}),
    Arztpraxis({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("1-2")
    ...
    Zahnarztpraxis({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("2-2") ||
                (it.startsWith("2-") && directoryEntry.directoryEntryBase.personalEntry == false)
    }}),
    Apotheke({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
    ...
    Psychotherapeut({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
    ...
    HBAGematik({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("9-") && directoryEntry.directoryEntryBase.personalEntry == true
    }}),
    SMCBGematik({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("9-") && directoryEntry.directoryEntryBase.personalEntry == false
    }}),
    HBAeGBR({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
        it.startsWith("10-") && directoryEntry.directoryEntryBase.personalEntry == true
    }}),
    SMCBeGBR({ directoryEntry -> directoryEntry.directoryEntryBase.telematikID.let {
