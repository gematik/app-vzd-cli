...
public class DeleteDirEntryCertExecutionIntegrationTest {
    ...
    public void delCommandSuccessTest() throws Exception {
        DeleteDirEntryCertExecution deleteDirEntryExecution = new DeleteDirEntryCertExecution(ConnectionPool.createConnectionPool(1));
    ...
    public void executeCommandEntryNotPresentTest() {
        ...
        ApiException exception = assertThrows(ApiException.class,
            () -> deleteDirEntryExecution.executeCommand(commands.get(1), deleteDirEntryExecution.connectionPool.getConnection()));
