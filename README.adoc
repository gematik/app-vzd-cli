= 🗂️ `vzd-cli`: Command Line Client für Verzeichnisdienste der TI 
:toc: auto
...
.Suche den Einträge mit spezifischen telematikID und zeige es als YAML
[source,bash]
----
bin/vzd-cli admin list --query telematikID=5-SMC-B-Testkarte-883110000092568 --output=yaml
----
