...
# es folgt eine Abfrage nach dem Vault Password
...
Vault Password kann alternativ über die Umgebungsvariable `VAULT_PASSWORD` gesetzt werden oder über `--password` Parameter angegeben werden (nicht empfohlen).
