...
=== `admin <tu|ru|pu> show <telematikID>`
...
=== `admin <tu|ru|pu> template`

Generiert die Dateivorlagen für `add` oder `modify` Befehle.
...
vzd-cli admin ru add-base -s telematikID=1-123123
